...
## Test script
```
bash <(wget -qO- https://github.com/alekvol/russian-iperf3-servers/raw/main/speedtest.sh)
```

Fast Mode
```
bash <(wget -qO- https://github.com/alekvol/russian-iperf3-servers/raw/main/speedtest.sh) -f
```
...
| Ertelecom Bryansk | Bryansk | st.bryansk.ertelecom.ru | 5201<br>5204<br>5206<br>5207 | ✅ |
...
📅 **Latest test:** 20.02.2026 08:36:31 (MSK, UTC+3)

✅ **Available**: 41/41 servers

❌ **Unavailable**: 0/41 servers

⏱️ **Execution time**: 216.8 seconds
